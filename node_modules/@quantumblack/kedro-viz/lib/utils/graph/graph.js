...
exports.graph = exports.addEdgeLinks = void 0;
 ...
 */
const graph = function (nodes, edges, layers) {
  ...
  nodes.forEach(node => (0, _common.offsetNode)(node, size.min));
  edges.forEach(edge => (0, _common.offsetEdge)(edge, size.min));
  return {
    nodes,
    edges,
    layers,
 ...
 */
exports.addEdgeLinks = addEdgeLinks;
...
const findNodeBy = (node, successors, order, accept, visited) => {
  ...
  .map(successor => findNodeBy(successor, successors, order, accept, visited))
