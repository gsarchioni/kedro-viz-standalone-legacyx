...
exports.getSeedFromURL = exports.getNumberArray = exports.generateHash = exports.default = exports.LOREM_IPSUM = void 0;
...
const getSeedFromURL = () => {
  ...
  if (typeof jest === 'undefined') {
    console.info("%cRandom data seed: ".concat(seed, "\nTo reuse this layout, visit ").concat(url.toString()), 'font-weight: bold');
  }
  return seed;
};
 ...
 */
exports.getSeedFromURL = getSeedFromURL;
const getNumberArray = length => Array.from(Array(length).keys());
exports.getNumberArray = getNumberArray;
const LOREM_IPSUM = exports.LOREM_IPSUM = 'lorem ipsum dolor sit amet consectetur adipiscing elit vestibulum id turpis nunc nulla vitae diam dignissim fermentum elit sit amet viverra libero quisque condimentum pellentesque convallis sed consequat neque ac rhoncus finibus'.split(' ');
...
const randomUtils = () => {
   ...
   */
  const getRandomName = function (numWords) {
    let join = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '_';
    return getNumberArray(numWords).map(() => getRandom(LOREM_IPSUM)).join(join);
  };
...
var _default = exports.default = randomUtils;