...
exports.saveLocalStorage = exports.pruneFalseyKeys = exports.loadLocalStorage = void 0;
...
const loadLocalStorage = function () {
  let itemKey = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _config.localStorageName;
  if (noWindow) {
    return {};
  }
  try {
...
exports.pruneFalseyKeys = pruneFalseyKeys;