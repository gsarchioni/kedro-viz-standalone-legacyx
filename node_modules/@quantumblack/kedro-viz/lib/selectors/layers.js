 ...
 * Get layer positions
 */
const getLayers = exports.getLayers = (0, _reselect.createSelector)([getGraph, _disabled.getVisibleLayerIDs, getLayerName], (_ref, layerIDs, layerName) => {
  let {
    nodes,
    size
  } = _ref;
  ...
  return layerIDs.map((id, i) => {
    ...
    const prevBound = bounds[layerIDs[i - 1]] || [currentBound[0], currentBound[0]];
    const nextBound = bounds[layerIDs[i + 1]] || [currentBound[1], currentBound[1]];
