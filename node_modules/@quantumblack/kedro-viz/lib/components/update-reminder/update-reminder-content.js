...
const updateContent = exports.updateContent = {
  date: '29 July 2024',
  features: [{
    title: '`Enable`/`disable` dataset preview in Kedro-Viz instance or when publishing',
    image: '',
    ...
    buttonLink: 'https://docs.kedro.org/projects/kedro-viz/en/latest/preview_datasets.html#disabling-previews',
    buttonText: 'View the docs'
  }, {
    title: 'Move session store and stats file to `.viz` directory conditionally',
    image: '',
